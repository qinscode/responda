        ...
        <div className="relative overflow-hidden bg-gradient-to-r from-white via-blue-50/30 to-indigo-50/30 rounded-2xl border border-gray-200/60 p-8 shadow-lg backdrop-blur-sm">
          ...
          <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button className="group flex items-center gap-2 hover:scale-105 transition-all duration-200 shadow-md hover:shadow-lg" size="sm" variant="outline">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="group relative overflow-hidden bg-gradient-to-br from-white to-blue-50/30 border-0 shadow-lg hover:shadow-xl transition-all duration-300 rounded-2xl hover:-translate-y-1">
            ...
            <CardContent className="relative p-6">
              ...
              <div>
                <div className="text-2xl font-bold text-gray-900 mb-1">{dashboardData.summary.totalRegions}</div>
          ...
          <Card className="group relative overflow-hidden bg-gradient-to-br from-white to-red-50/30 border-0 shadow-lg hover:shadow-xl transition-all duration-300 rounded-2xl hover:-translate-y-1">
            ...
            <CardContent className="relative p-6">
              ...
              <div>
                <div className="text-2xl font-bold text-gray-900 mb-1">{dashboardData.summary.activeAlerts}</div>
          ...
          <Card className="group relative overflow-hidden bg-gradient-to-br from-white to-orange-50/30 border-0 shadow-lg hover:shadow-xl transition-all duration-300 rounded-2xl hover:-translate-y-1">
            ...
            <CardContent className="relative p-6">
              ...
              <div>
                <div className="text-2xl font-bold text-gray-900 mb-1">{dashboardData.summary.highRiskRegions}</div>
                <div className="text-sm text-gray-600 mb-2">High Risk Regions</div>
        ...
        <Tabs className="space-y-8" defaultValue="trends">
          <div className="relative">
            ...
            <TabsList className="relative grid w-full grid-cols-4 bg-white/80 backdrop-blur-sm p-2 rounded-2xl border border-gray-200/60 shadow-lg h-14">
              <TabsTrigger className="group flex items-center justify-center gap-2 h-full data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-500 data-[state=active]:to-indigo-500 data-[state=active]:text-white data-[state=active]:shadow-md text-gray-600 hover:text-gray-900 transition-all duration-300 rounded-xl font-medium hover:bg-gray-50" value="trends">
                <TrendingUp className="h-4 w-4 group-data-[state=active]:animate-pulse" />
                Trends
              </TabsTrigger>
              <TabsTrigger className="group flex items-center justify-center gap-2 h-full data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-500 data-[state=active]:to-indigo-500 data-[state=active]:text-white data-[state=active]:shadow-md text-gray-600 hover:text-gray-900 transition-all duration-300 rounded-xl font-medium hover:bg-gray-50" value="predictions">
                <Brain className="h-4 w-4 group-data-[state=active]:animate-pulse" />
                Predictions
              </TabsTrigger>
              <TabsTrigger className="group flex items-center justify-center gap-2 h-full data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-500 data-[state=active]:to-indigo-500 data-[state=active]:text-white data-[state=active]:shadow-md text-gray-600 hover:text-gray-900 transition-all duration-300 rounded-xl font-medium hover:bg-gray-50" value="risk-analysis">
                <Shield className="h-4 w-4 group-data-[state=active]:animate-pulse" />
                Risk Analysis
              </TabsTrigger>
              <TabsTrigger className="group flex items-center justify-center gap-2 h-full data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-500 data-[state=active]:to-indigo-500 data-[state=active]:text-white data-[state=active]:shadow-md text-gray-600 hover:text-gray-900 transition-all duration-300 rounded-xl font-medium hover:bg-gray-50" value="insights">
              ...
              <CardContent className="relative">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="group space-y-3 p-6 bg-white/60 backdrop-blur-sm rounded-xl border border-gray-100 hover:shadow-md transition-all duration-300 hover:-translate-y-1">
                    <div className="text-sm font-semibold text-gray-900">Bushfire Trend</div>
                    <div className="flex items-center gap-3">
                      <Badge 
                  ...
                  <div className="group space-y-3 p-6 bg-white/60 backdrop-blur-sm rounded-xl border border-gray-100 hover:shadow-md transition-all duration-300 hover:-translate-y-1">
                    <div className="text-sm font-semibold text-gray-900">Flood Trend</div>
                    <div className="flex items-center gap-3">
                      <Badge 
                        className="capitalize shadow-sm"
                  ...
                  <div className="group space-y-3 p-6 bg-white/60 backdrop-blur-sm rounded-xl border border-gray-100 hover:shadow-md transition-all duration-300 hover:-translate-y-1">
                    <div className="text-sm font-semibold text-gray-900">Overall Risk</div>
                    <div className="flex items-center gap-3">
                      <Badge 
                        className="capitalize shadow-sm"
              ...
              <CardContent className="relative">
                <div className="space-y-4">
                  {dashboardData.modelPerformance.map((performance, index) => {
                    ...
                    return (
                      <div key={performance.modelId} className="group flex items-center justify-between p-6 bg-white/60 backdrop-blur-sm border border-gray-100 rounded-xl hover:shadow-md hover:bg-white/80 transition-all duration-300 hover:-translate-y-1">
                        <div className="flex-1">
                          <div className="font-semibold text-lg text-gray-900">{model?.name}</div>
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 text-center">
                          <div className="p-3 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg hover:scale-105 transition-transform duration-200">
                            <div className="text-lg font-bold text-blue-700">{(performance.accuracy * 100).toFixed(1)}%</div>
                          ...
                          <div className="p-3 bg-gradient-to-br from-green-50 to-green-100 rounded-lg hover:scale-105 transition-transform duration-200">
                            <div className="text-lg font-bold text-green-700">{(performance.precision * 100).toFixed(1)}%</div>
                          ...
                          <div className="p-3 bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg hover:scale-105 transition-transform duration-200">
                            <div className="text-lg font-bold text-orange-700">{(performance.recall * 100).toFixed(1)}%</div>
                            <div className="text-xs text-orange-600 font-medium">Recall</div>
                          </div>
                          <div className="p-3 bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg hover:scale-105 transition-transform duration-200">
                            <div className="text-lg font-bold text-purple-700">{(performance.f1Score * 100).toFixed(1)}%</div>
              ...
              <CardContent className="relative">
                <div className="space-y-6">
                  {mockCorrelationAnalysis.insights.map((insight, index) => (
                    <div key={index} className="group flex items-start gap-4 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200/50 rounded-xl hover:shadow-md transition-all duration-300 hover:-translate-y-1">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-blue-700 leading-relaxed">{insight}</div>
                      </div>
                    </div>
                  ))}
